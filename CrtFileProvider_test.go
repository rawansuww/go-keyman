...
func TestFetchKeysFromStoreECDSA(t *testing.T) {
	...
	//PROBLEM with ecdsa structure and rsa structure. how to compare big int
	...
	// pub := key.PublicKey.(*ecdsa.PublicKey).N.String()
	// priv := key.PrivateKey.(*ecdsa.PrivateKey).N.String()
